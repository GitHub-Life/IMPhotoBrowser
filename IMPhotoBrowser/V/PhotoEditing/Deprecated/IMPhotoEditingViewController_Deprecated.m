//
//  IMPhotoEditingViewController_Deprecated.m
//  IMPhotoBrowserDemo
//
...
#import "IMPhotoEditingViewController_Deprecated.h"
#import <Masonry.h>
...
@interface IMPhotoEditingViewController_Deprecated () <UIScrollViewDelegate>
...
@property (nonatomic, strong) IMPhotoEditingMaskView_Deprecated *editingMaskView;
...
@implementation IMPhotoEditingViewController_Deprecated
...
- (void)initView {
    ...
    _editingMaskView = [[IMPhotoEditingMaskView_Deprecated alloc] initWithFrame:CGRectMake(0, 0, _screenW, _screenH)];
